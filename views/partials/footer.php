        ...
        <div class="row g-4">
            ...
            <div class="col-lg-2 col-md-6">
                ...
                <ul class="footer-links">
                    <li class="footer-link-item"><a href="<?php echo BASE_URL; ?>" class="footer-link">Home</a></li>
                    <li class="footer-link-item"><a href="<?php echo BASE_URL; ?>about" class="footer-link">About Us</a></li>
                    <li class="footer-link-item"><a href="<?php echo BASE_URL; ?>products" class="footer-link">Products</a></li>
                    <li class="footer-link-item"><a href="<?php echo BASE_URL; ?>contact" class="footer-link">Contact</a></li>
                </ul>
            </div>
